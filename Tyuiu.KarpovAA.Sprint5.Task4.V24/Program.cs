...
using Tyuiu.KarpovAA.Sprint5.Task4.V24.Lib;
using System.IO;

namespace Tyuiu.KarpovAA.Sprint5.Task4.V24
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* значение из файла и подставить вместо Х в формуле y = (x^-2 + 2)sin(x)  *");
